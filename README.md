...
## Technical Choices
As the sole backend developer in a cross-functional team of designers and front-end developers, my focus was on Autonomy and Developer Experience (DX).
This way we can push the product with agility, not having a bottleneck on backend development integrating and monitoring it easily.